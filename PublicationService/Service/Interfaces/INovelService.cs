...
namespace NovelService.Service.Interfaces
{
    public interface INovelService
    {
        ...
        Task<NovelDetailDto?> UpdateNovelAsync(int novel_Id, NovelUpdateDto dto, Guid uploader_id, int series_Id);
        Task<NovelDetailDto?> GetNovelByID(int novel_Id, int series_Id);
        Task<bool> DeleteNovelAsync(int novel_id, Guid uploader_Id, int series_Id);

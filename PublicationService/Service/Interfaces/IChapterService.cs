...
namespace NovelService.Service.Interfaces
{
    public interface IChapterService
    {
        ...
        Task<ChapterDetailDto?> UpdateChapterAsync(int chapter_id, ChapterUpdateDto dto, Guid uploader_id, int? novelId = null, int? seriesId = null);
        Task<ChapterDetailDto?> GetChapterById(int chapter_id, int? novelId = null, int? seriesId = null);
        Task<bool> DeleteChapterById (int chapter_id, Guid uploaderId, int? novelId = null, int? seriesId = null);
